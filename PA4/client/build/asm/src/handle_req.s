...
.L59:
	...
	call	gai_strerror@PLT
	movq	%rax, %rdx
	.loc 1 257 13 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC2(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L62:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 271 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC4(%rip), %rsi
	movq	%rax, %rdi
...
.L64:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 281 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
