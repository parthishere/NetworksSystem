...
.L37:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 153 17 is_stmt 0 discriminator 1
	movq	-184(%rbp), %rsi
	movq	-176(%rbp), %rax
	movl	(%rax), %eax
	movl	$0, %ecx
	movl	%eax, %edi
	call	send@PLT
	.loc 1 153 16 is_stmt 1 discriminator 2
	testq	%rax, %rax
	jns	.L34
	.loc 1 155 51
	call	__errno_location@PLT
...
.LBE4:
	...
	call	gettid@PLT
	movl	%eax, %r12d
	.loc 1 176 9 is_stmt 0 discriminator 1
	movq	-176(%rbp), %rax
	movq	16(%rax), %rbx
	call	gettid@PLT
...
.L54:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 241 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC4(%rip), %rsi
	movq	%rax, %rdi
...
.L56:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 251 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
...
.L58:
	...
	testl	%eax, %eax
	jns	.L59
	.loc 1 258 63 is_stmt 0 discriminator 1
	movq	-216(%rbp), %rax
	movl	40(%rax), %eax
	jmp	.L60
.L59:
	...
	subl	-220(%rbp), %eax
.L60:
	.loc 1 258 13 is_stmt 1 discriminator 4
	movl	%eax, -180(%rbp)
	.loc 1 259 9
	leaq	.LC6(%rip), %rax
	movq	%rax, %rdi
...
.L65:
	...
	nop
.L64:
	.loc 1 274 53 discriminator 2
	addl	$1, -188(%rbp)
.L63:
	.loc 1 274 31 discriminator 1
	movq	-216(%rbp), %rax
	movl	40(%rax), %eax
...
.LBB10:
	...
	jmp	.L77
.L78:
	.loc 1 335 5 is_stmt 0 discriminator 3
	movq	-43232(%rbp), %rax
	movl	-43256(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -43256(%rbp)
.L77:
	.loc 1 335 5 discriminator 1
	cmpl	$15, -43256(%rbp)
	jbe	.L78
.LBE10:
	.loc 1 339 20 is_stmt 1
	movq	$10, -43184(%rbp)
	movq	$0, -43176(%rbp)
	.loc 1 341 20
	movq	-43272(%rbp), %rax
...
.L94:
	...
	call	printf@PLT
.LBE13:
	.loc 1 376 53 discriminator 2
	addl	$1, -43248(%rbp)
.L92:
	.loc 1 376 31 discriminator 1
	movq	-43272(%rbp), %rax
	movl	40(%rax), %eax
