...
.L22:
	...
	movq	%rax, %rdx
	.loc 1 110 13 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC2(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L23:
	...
	movl	%eax, %edi
	call	socket@PLT
	.loc 1 116 42 discriminator 1
	movq	-176(%rbp), %rdx
	movl	%eax, (%rdx)
	.loc 1 116 25 discriminator 1
	movq	-176(%rbp), %rax
	movl	(%rax), %eax
...
.L26:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 124 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC4(%rip), %rsi
	movq	%rax, %rdi
...
.L30:
	...
	testl	%eax, %eax
	jns	.L31
	.loc 1 141 63 is_stmt 0 discriminator 1
	movq	-216(%rbp), %rax
	movl	40(%rax), %eax
	jmp	.L32
.L31:
	.loc 1 141 63 discriminator 2
	movl	-196(%rbp), %eax
	subl	16(%rbp), %eax
.L32:
	.loc 1 141 13 is_stmt 1 discriminator 4
	movl	%eax, -180(%rbp)
	.loc 1 142 9
	leaq	.LC6(%rip), %rax
	movq	%rax, %rdi
...
.LBE4:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 157 13 is_stmt 0 discriminator 1
	movq	-176(%rbp), %rax
	movl	(%rax), %eax
	movq	-240(%rbp), %rsi
	movl	$0, %ecx
	movl	%eax, %edi
	call	send@PLT
	.loc 1 157 12 is_stmt 1 discriminator 2
	testq	%rax, %rax
	jns	.L41
	.loc 1 159 47
	call	__errno_location@PLT
...
.L51:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 221 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC4(%rip), %rsi
	movq	%rax, %rdi
...
.L53:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 231 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
...
.L55:
	...
	testl	%eax, %eax
	jns	.L56
	.loc 1 238 63 is_stmt 0 discriminator 1
	movq	-216(%rbp), %rax
	movl	40(%rax), %eax
	jmp	.L57
.L56:
	.loc 1 238 63 discriminator 2
	movl	-196(%rbp), %eax
	subl	-220(%rbp), %eax
.L57:
	.loc 1 238 13 is_stmt 1 discriminator 4
	movl	%eax, -180(%rbp)
	.loc 1 239 9
	leaq	.LC6(%rip), %rax
	movq	%rax, %rdi
...
.LBB9:
	...
	jmp	.L74
.L75:
	.loc 1 315 5 is_stmt 0 discriminator 3
	movq	-43232(%rbp), %rax
	movl	-43256(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -43256(%rbp)
...
.L91:
	...
	movb	%dl, (%rax)
.LBE12:
	.loc 1 356 53 discriminator 2
	addl	$1, -43248(%rbp)
.L89:
	.loc 1 356 31 discriminator 1
	movq	-43272(%rbp), %rax
	movl	40(%rax), %eax
	.loc 1 356 27 discriminator 1
	cmpl	%eax, -43248(%rbp)
	jl	.L92
.LBE11:
	.loc 1 377 26
