...
.L55:
	...
	call	gai_strerror@PLT
	movq	%rax, %rdx
	.loc 1 252 13 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC2(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L56:
	...
	movl	%eax, %edi
	call	socket@PLT
	.loc 1 258 42 discriminator 1
	movq	-30952(%rbp), %rdx
	movl	%eax, (%rdx)
	.loc 1 258 25 discriminator 1
	movq	-30952(%rbp), %rax
	movl	(%rax), %eax
...
.L61:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 276 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
...
.L63:
	...
	testl	%eax, %eax
	jns	.L64
	.loc 1 283 63 is_stmt 0 discriminator 1
	movq	-31000(%rbp), %rax
	movl	40(%rax), %eax
	jmp	.L65
.L64:
	.loc 1 283 63 discriminator 2
	movl	-30988(%rbp), %eax
	subl	-31004(%rbp), %eax
.L65:
	.loc 1 283 13 is_stmt 1 discriminator 4
	movl	%eax, -30984(%rbp)
	.loc 1 284 9
	leaq	.LC14(%rip), %rax
	movq	%rax, %rdi
...
.LBE9:
	...
	call	gettid@PLT
	movl	%eax, %r12d
	.loc 1 349 9 is_stmt 0 discriminator 1
	movq	-30952(%rbp), %rax
	movq	16(%rax), %rbx
	call	gettid@PLT
	.loc 1 349 9 discriminator 2
	leaq	-30816(%rbp), %rdx
	movq	%r13, %r9
	movq	%rdx, %r8
	movl	%r12d, %ecx
...
.L73:
	...
	nop
.L72:
	.loc 1 354 53 discriminator 2
	addl	$1, -30972(%rbp)
.L71:
	.loc 1 354 31 discriminator 1
	movq	-31000(%rbp), %rax
	movl	40(%rax), %eax
...
.LFB326:
	...
	movq	%rax, %rdi
	call	str2md5
	.loc 1 414 82 discriminator 2
	movq	-8(%rbp), %rdx
	movl	40(%rdx), %edx
	movl	%edx, %ecx
	.loc 1 414 78 discriminator 2
	movl	$0, %edx
	divl	%ecx
	movl	%edx, %eax
...
.LBB14:
	...
	jmp	.L88
.L89:
	.loc 1 441 5 is_stmt 0 discriminator 3
	movq	-30888(%rbp), %rax
	movl	-30892(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -30892(%rbp)
.L88:
	.loc 1 441 5 discriminator 1
	cmpl	$15, -30892(%rbp)
	jbe	.L89
.LBE14:
	.loc 1 445 20 is_stmt 1
	movq	$10, -30880(%rbp)
	movq	$0, -30872(%rbp)
	.loc 1 448 15
	movq	-30904(%rbp), %rax
