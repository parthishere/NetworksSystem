...
.LC12:
	...
	.align 8
.LC13:
	.string	"numbytes read from file for GET:%d -%s\n"
.LC14:
	.string	"send bytes:%d\n"
.LC15:
	.string	"lessgoo"
...
.LBE3:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 216 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movq	%r12, %r8
	movl	%ebx, %ecx
	leaq	.LC16(%rip), %rsi
...
.L28:
	...
	.loc 1 224 13
	call	gettid@PLT
	.loc 1 224 13 is_stmt 0 discriminator 1
	movl	$2, %edx
	movl	%eax, %esi
	leaq	.LC17(%rip), %rax
	movq	%rax, %rdi
...
.LBB4:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 240 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC18(%rip), %rsi
	movq	%rax, %rdi
...
.L32:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 246 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC19(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
