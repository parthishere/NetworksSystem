...
.L45:
	...
	call	strerror@PLT
	movq	%rax, %rdx
	.loc 1 277 9 is_stmt 0 discriminator 3
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
...
.L63:
	...
	cmpl	$0, -30756(%rbp)
	jne	.L65
	.loc 1 357 16 discriminator 3
	movq	-30776(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 357 16 discriminator 1
	call	__errno_location@PLT
	.loc 1 357 16 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
	...
	jmp	.L64
.L65:
	.loc 1 357 16 discriminator 4
	movl	-30756(%rbp), %eax
.LBE16:
	.loc 1 357 14 is_stmt 1 discriminator 4
	movl	%eax, -30760(%rbp)
	.loc 1 358 5
	leaq	-30736(%rbp), %rax
	movq	%rax, %rsi
...
.LBB18:
	...
	jmp	.L72
.L73:
	.loc 1 420 9 is_stmt 0 discriminator 3
	movq	-30920(%rbp), %rax
	movl	-30936(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -30936(%rbp)
...
.L78:
	...
	cmpl	$0, -30924(%rbp)
	jne	.L80
	.loc 1 454 13 discriminator 4
	movq	-30952(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 454 13 discriminator 1
	call	__errno_location@PLT
	.loc 1 454 13 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
...
.LBE20:
	...
	testb	%al, %al
	je	.L82
	.loc 1 459 72 discriminator 1
	movzbl	-30908(%rbp), %eax
	.loc 1 460 56
	cmpb	$3, %al
	je	.L83
	.loc 1 460 72 discriminator 1
	movzbl	-30908(%rbp), %eax
	.loc 1 461 56
	cmpb	$2, %al
	je	.L84
