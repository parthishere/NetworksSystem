...
.LBB15:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 226 16 is_stmt 0 discriminator 1
	movl	%eax, -30756(%rbp)
	cmpl	$0, -30756(%rbp)
	jg	.L47
	call	__errno_location@PLT
...
.L47:
	...
	cmpl	$0, -30756(%rbp)
	jne	.L49
	.loc 1 226 16 discriminator 3
	movq	-30776(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 226 16 discriminator 1
	call	__errno_location@PLT
	.loc 1 226 16 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
	...
	call	printf@PLT
.L49:
	.loc 1 226 16 discriminator 5
	movl	-30756(%rbp), %eax
.LBE15:
	.loc 1 226 14 is_stmt 1 discriminator 5
	movl	%eax, -30760(%rbp)
	.loc 1 227 5
	leaq	-30736(%rbp), %rax
	movq	%rax, %rsi
...
.LBB17:
	...
	jmp	.L56
.L57:
	.loc 1 279 9 is_stmt 0 discriminator 3
	movq	-30920(%rbp), %rax
	movl	-30940(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -30940(%rbp)
...
.LBE17:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 290 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movq	%r12, %r8
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
...
.L58:
	...
	.loc 1 298 13
	call	gettid@PLT
	.loc 1 298 13 is_stmt 0 discriminator 1
	movl	$2, %edx
	movl	%eax, %esi
	leaq	.LC18(%rip), %rax
	movq	%rax, %rdi
...
.LBB19:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 313 13 is_stmt 0 discriminator 1
	movl	%eax, -30928(%rbp)
	cmpl	$0, -30928(%rbp)
	jg	.L62
	call	__errno_location@PLT
...
.LBE19:
.LBE18:
	.loc 1 292 13 is_stmt 1 discriminator 1
	jmp	.L70
.L62:
.LBB21:
.LBB20:
	...
	cmpl	$0, -30928(%rbp)
	jne	.L64
	.loc 1 313 13 is_stmt 0 discriminator 4
	movq	-30952(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 313 13 discriminator 1
	call	__errno_location@PLT
	.loc 1 313 13 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
