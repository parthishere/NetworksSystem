...
.LBB2:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 78 16 is_stmt 0 discriminator 1
	movl	%eax, -30792(%rbp)
	cmpl	$0, -30792(%rbp)
	jns	.L5
...
.L5:
	...
	jmp	.L6
.L7:
	.loc 1 78 16 discriminator 4
	movl	-30792(%rbp), %eax
.LBE2:
	.loc 1 78 14 is_stmt 1 discriminator 4
	movl	%eax, -30800(%rbp)
	.loc 1 80 21
	leaq	-30752(%rbp), %rax
	movl	$47, %esi
...
.L18:
	...
	movl	-30780(%rbp), %eax
.LBE4:
	.loc 1 119 18 is_stmt 1 discriminator 2
	movl	%eax, -30800(%rbp)
	.loc 1 120 9
	leaq	.LC9(%rip), %rax
	movq	%rax, %rdi
...
.L19:
	...
	movl	-30784(%rbp), %eax
.LBE5:
	.loc 1 129 18 is_stmt 1 discriminator 2
	movl	%eax, -30800(%rbp)
	.loc 1 130 9
	leaq	.LC15(%rip), %rax
	movq	%rax, %rdi
...
.LBB6:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 152 16 is_stmt 0 discriminator 1
	movl	%eax, -61532(%rbp)
	cmpl	$0, -61532(%rbp)
	jns	.L22
	call	__errno_location@PLT
...
.L24:
	...
	movl	-61532(%rbp), %eax
.LBE6:
	.loc 1 152 14 is_stmt 1 discriminator 4
	movl	%eax, -61544(%rbp)
	.loc 1 154 21
	leaq	-61456(%rbp), %rax
	movl	$47, %esi
...
.LBB7:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 170 20 is_stmt 0 discriminator 1
	movl	%eax, -61508(%rbp)
	cmpl	$0, -61508(%rbp)
	jg	.L28
	call	__errno_location@PLT
...
.L28:
	...
	movl	-61508(%rbp), %eax
.LBE7:
	.loc 1 170 18 is_stmt 1 discriminator 2
	movl	%eax, -61544(%rbp)
	.loc 1 171 16
	movl	$-1, -61536(%rbp)
	.loc 1 172 9
...
.L30:
	...
	movl	-61524(%rbp), %eax
.LBE8:
	.loc 1 182 14 is_stmt 1 discriminator 2
	movl	%eax, -61544(%rbp)
	.loc 1 183 5
	movl	-61544(%rbp), %eax
	movl	%eax, %esi
...
.LBB9:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 193 16 is_stmt 0 discriminator 1
	movl	%eax, -61520(%rbp)
	cmpl	$0, -61520(%rbp)
	jg	.L31
	call	__errno_location@PLT
...
.L31:
	...
	movl	-61520(%rbp), %eax
.LBE9:
	.loc 1 193 14 is_stmt 1 discriminator 2
	movl	%eax, -61544(%rbp)
	.loc 1 194 5
	movl	-61460(%rbp), %esi
	movl	-61464(%rbp), %ecx
...
.LBB11:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 208 20 is_stmt 0 discriminator 1
	movl	%eax, -61512(%rbp)
	cmpl	$0, -61512(%rbp)
	jg	.L35
	call	__errno_location@PLT
...
.L35:
	...
	movl	-61512(%rbp), %eax
.LBE11:
	.loc 1 208 18 is_stmt 1 discriminator 2
	movl	%eax, -61544(%rbp)
	.loc 1 209 9
	movl	-61544(%rbp), %eax
	movl	%eax, %esi
...
.LBB12:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 215 16 is_stmt 0 discriminator 1
	movl	%eax, -61516(%rbp)
	cmpl	$0, -61516(%rbp)
	jns	.L37
	call	__errno_location@PLT
...
.L37:
	...
	cmpl	$0, -61516(%rbp)
	jne	.L38
	.loc 1 215 16 discriminator 3
	movq	-61560(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 215 16 discriminator 1
	call	__errno_location@PLT
	.loc 1 215 16 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
	...
	jmp	.L23
.L38:
	.loc 1 215 16 discriminator 4
	movl	-61516(%rbp), %eax
.LBE12:
	.loc 1 215 14 is_stmt 1 discriminator 4
	movl	%eax, -61544(%rbp)
	.loc 1 216 9
	leaq	-61456(%rbp), %rax
	movl	$7, %edx
...
.LFB324:
	...
	call	strerror@PLT
	movq	%rax, %rdx
	.loc 1 278 9 is_stmt 0 discriminator 3
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
...
.LBB13:
	...
	testl	%eax, %eax
	je	.L55
	.loc 1 285 60 discriminator 2
	movq	-8400(%rbp), %rax
	addq	$19, %rax
	.loc 1 285 48 discriminator 2
	leaq	.LC39(%rip), %rdx
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	strcmp@PLT
...
.LBB16:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 342 16 is_stmt 0 discriminator 1
	movl	%eax, -30756(%rbp)
	cmpl	$0, -30756(%rbp)
	jns	.L57
	call	__errno_location@PLT
...
.L59:
	...
	movl	-30756(%rbp), %eax
.LBE16:
	.loc 1 342 14 is_stmt 1 discriminator 4
	movl	%eax, -30760(%rbp)
	.loc 1 345 78
	movq	-30784(%rbp), %rax
	movzbl	1(%rax), %eax
...
.LBB18:
	...
	jmp	.L66
.L67:
	.loc 1 404 9 is_stmt 0 discriminator 3
	movq	-30920(%rbp), %rax
	movl	-30936(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -30936(%rbp)
...
.LBE18:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 415 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movq	%r12, %r8
	movl	%ebx, %ecx
	leaq	.LC48(%rip), %rsi
...
.LBB20:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 438 13 is_stmt 0 discriminator 1
	movl	%eax, -30924(%rbp)
	cmpl	$0, -30924(%rbp)
	jns	.L72
	call	__errno_location@PLT
...
.L72:
	...
	cmpl	$0, -30924(%rbp)
	jne	.L74
	.loc 1 438 13 discriminator 4
	movq	-30952(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 438 13 discriminator 1
	call	__errno_location@PLT
	.loc 1 438 13 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
...
.LBE20:
	...
	testb	%al, %al
	je	.L76
	.loc 1 443 72 discriminator 1
	movzbl	-30906(%rbp), %eax
	.loc 1 444 56
	cmpb	$3, %al
	je	.L77
	.loc 1 444 72 discriminator 1
	movzbl	-30906(%rbp), %eax
	.loc 1 445 56
	cmpb	$2, %al
	je	.L78
	.loc 1 445 72 discriminator 1
	movzbl	-30906(%rbp), %eax
	.loc 1 446 96
	cmpb	$5, %al
	jne	.L79
	.loc 1 446 96 is_stmt 0 discriminator 1
	leaq	.LC51(%rip), %rax
	jmp	.L84
.L79:
	.loc 1 446 96 discriminator 2
	leaq	.LC52(%rip), %rax
	jmp	.L84
.L78:
	.loc 1 445 56 is_stmt 1 discriminator 2
	leaq	.LC53(%rip), %rax
	jmp	.L84
.L77:
	.loc 1 444 56 discriminator 2
	leaq	.LC54(%rip), %rax
	jmp	.L84
.L76:
	.loc 1 443 56 discriminator 2
	leaq	.LC55(%rip), %rax
	jmp	.L84
.L75:
	.loc 1 441 13 discriminator 1
	leaq	.LC56(%rip), %rax
.L84:
	.loc 1 441 13 is_stmt 0 discriminator 3
	movq	%rax, %rsi
	leaq	.LC57(%rip), %rax
	movq	%rax, %rdi
	movl	$0, %eax
	call	printf@PLT
	.loc 1 447 71 is_stmt 1
