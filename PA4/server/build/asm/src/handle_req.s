...
.LBB9:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 185 16 is_stmt 0 discriminator 1
	movl	%eax, -61524(%rbp)
	cmpl	$0, -61524(%rbp)
	jns	.L31
	call	__errno_location@PLT
...
.L31:
	...
	jmp	.L23
.L32:
	.loc 1 185 16 discriminator 4
	movl	-61524(%rbp), %eax
.LBE9:
	.loc 1 185 14 is_stmt 1 discriminator 4
	movl	%eax, -61548(%rbp)
	.loc 1 187 22
	movb	$0, -61466(%rbp)
	.loc 1 189 35
...
.LBB10:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 195 16 is_stmt 0 discriminator 1
	movl	%eax, -61520(%rbp)
	cmpl	$0, -61520(%rbp)
	jg	.L33
	call	__errno_location@PLT
...
.L37:
	...
	movl	-61512(%rbp), %eax
.LBE12:
	.loc 1 210 18 is_stmt 1 discriminator 2
	movl	%eax, -61548(%rbp)
	.loc 1 211 9
	movl	-61548(%rbp), %eax
	movl	%eax, %esi
...
.L39:
	...
	jmp	.L23
.L40:
	.loc 1 217 16 discriminator 4
	movl	-61516(%rbp), %eax
.LBE13:
	.loc 1 217 14 is_stmt 1 discriminator 4
	movl	%eax, -61548(%rbp)
	.loc 1 218 9
	leaq	-61456(%rbp), %rax
	movl	$7, %edx
...
.LFB324:
	...
	call	strerror@PLT
	movq	%rax, %rdx
	.loc 1 280 9 is_stmt 0 discriminator 3
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC5(%rip), %rsi
	movq	%rax, %rdi
...
.LBB14:
	...
	testl	%eax, %eax
	je	.L57
	.loc 1 287 60 discriminator 2
	movq	-8400(%rbp), %rax
	addq	$19, %rax
	.loc 1 287 48 discriminator 2
	leaq	.LC39(%rip), %rdx
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	strcmp@PLT
...
.L59:
	...
	cmpl	$0, -30756(%rbp)
	jne	.L61
	.loc 1 344 16 discriminator 3
	movq	-30776(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 344 16 discriminator 1
	call	__errno_location@PLT
	.loc 1 344 16 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
	...
	jmp	.L60
.L61:
	.loc 1 344 16 discriminator 4
	movl	-30756(%rbp), %eax
.LBE17:
	.loc 1 344 14 is_stmt 1 discriminator 4
	movl	%eax, -30760(%rbp)
	.loc 1 347 78
	movq	-30784(%rbp), %rax
	movzbl	1(%rax), %eax
...
.LBB21:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 440 13 is_stmt 0 discriminator 1
	movl	%eax, -30924(%rbp)
	cmpl	$0, -30924(%rbp)
	jns	.L74
	call	__errno_location@PLT
...
.LBE21:
	...
	cmpb	$3, %al
	je	.L79
	.loc 1 446 72 discriminator 1
	movzbl	-30906(%rbp), %eax
	.loc 1 447 56
	cmpb	$2, %al
	je	.L80
	.loc 1 447 72 discriminator 1
	movzbl	-30906(%rbp), %eax
	.loc 1 448 96
	cmpb	$5, %al
	jne	.L81
	.loc 1 448 96 is_stmt 0 discriminator 1
	leaq	.LC51(%rip), %rax
	jmp	.L86
.L81:
	.loc 1 448 96 discriminator 2
	leaq	.LC52(%rip), %rax
	jmp	.L86
.L80:
	.loc 1 447 56 is_stmt 1 discriminator 2
	leaq	.LC53(%rip), %rax
	jmp	.L86
.L79:
	.loc 1 446 56 discriminator 2
	leaq	.LC54(%rip), %rax
	jmp	.L86
.L78:
	.loc 1 445 56 discriminator 2
	leaq	.LC55(%rip), %rax
	jmp	.L86
.L77:
	.loc 1 443 13 discriminator 1
	leaq	.LC56(%rip), %rax
.L86:
	.loc 1 443 13 is_stmt 0 discriminator 3
	movq	%rax, %rsi
	leaq	.LC57(%rip), %rax
	movq	%rax, %rdi
	movl	$0, %eax
	call	printf@PLT
	.loc 1 449 71 is_stmt 1
