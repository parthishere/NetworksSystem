...
.LBB11:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 184 16 is_stmt 0 discriminator 1
	movl	%eax, -61508(%rbp)
	cmpl	$0, -61508(%rbp)
	jns	.L39
	call	__errno_location@PLT
...
.L39:
	...
	cmpl	$0, -61508(%rbp)
	jne	.L40
	.loc 1 184 16 discriminator 3
	movq	-61544(%rbp), %rax
	movl	4(%rax), %eax
	movl	%eax, %edi
	call	close@PLT
	.loc 1 184 16 discriminator 1
	call	__errno_location@PLT
	.loc 1 184 16 discriminator 2
	movl	(%rax), %eax
	movl	%eax, %esi
...
.L40:
	...
	movl	-61508(%rbp), %eax
.LBE11:
	.loc 1 184 14 is_stmt 1 discriminator 4
	movl	%eax, -61528(%rbp)
	.loc 1 193 11
	jmp	.L41
.L44:
...
.L42:
	...
	jmp	.L28
.L43:
	.loc 1 195 20 discriminator 4
	movl	-61496(%rbp), %eax
.LBE12:
	.loc 1 195 18 is_stmt 1 discriminator 4
	movl	%eax, -61528(%rbp)
	.loc 1 196 9
	movl	-61528(%rbp), %eax
	movl	%eax, %esi
...
.LBB14:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 219 16 is_stmt 0 discriminator 1
	movl	%eax, -61500(%rbp)
	cmpl	$0, -61500(%rbp)
	jns	.L49
	call	__errno_location@PLT
...
.L49:
	...
	jmp	.L28
.L50:
	.loc 1 219 16 discriminator 4
	movl	-61500(%rbp), %eax
.LBE14:
	.loc 1 219 14 is_stmt 1 discriminator 4
	movl	%eax, -61528(%rbp)
.L28:
	.loc 1 223 7
	cmpq	$0, -61480(%rbp)
...
.LFB313:
	...
	call	strerror@PLT
	movq	%rax, %rdx
	.loc 1 266 9 is_stmt 0 discriminator 3
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC6(%rip), %rsi
	movq	%rax, %rdi
...
.LBB15:
	...
	testl	%eax, %eax
	je	.L66
	.loc 1 273 60 discriminator 2
	movq	-8400(%rbp), %rax
	addq	$19, %rax
	.loc 1 273 48 discriminator 2
	leaq	.LC36(%rip), %rdx
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	strcmp@PLT
	.loc 1 273 45 discriminator 1
	testl	%eax, %eax
	je	.L66
	.loc 1 280 75
	movq	-8400(%rbp), %rax
...
.LBB23:
	...
	movl	%eax, %edi
	call	send@PLT
	.loc 1 442 13 is_stmt 0 discriminator 1
	movl	%eax, -30924(%rbp)
	cmpl	$0, -30924(%rbp)
	jns	.L97
	call	__errno_location@PLT
