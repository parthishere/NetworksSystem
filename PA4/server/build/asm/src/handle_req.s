...
.LBB3:
	...
	jmp	.L27
.L28:
	.loc 1 181 9 is_stmt 0 discriminator 3
	movq	-30920(%rbp), %rax
	movl	-30936(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -30936(%rbp)
...
.L33:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 222 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC15(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
