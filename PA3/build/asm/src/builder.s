...
.L56:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 390 13 is_stmt 0 discriminator 1
	movl	-30796(%rbp), %edx
	movq	-30776(%rbp), %rax
	movl	%edx, %ecx
	movq	%rax, %rdx
...
.Letext0:
	...
	.file 12 "./common.h"
	.file 13 "/usr/include/x86_64-linux-gnu/bits/unistd_ext.h"
