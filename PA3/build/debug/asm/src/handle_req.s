...
.LC37:
	...
	.align 8
.LC38:
	.string	"\033[31m[-] (%d) Missing Content-Length in non-chunked response\n\033[0m"
	.align 8
.LC39:
...
.LBB8:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 240 13 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC28(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L49:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 245 13 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC29(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.LBE12:
	...
	cmpl	$-1, -30956(%rbp)
	jne	.L53
	.loc 1 300 42 discriminator 1
	cmpl	$0, -30948(%rbp)
	jne	.L53
	.loc 1 304 21
	call	gettid@PLT
	.loc 1 304 21 is_stmt 0 discriminator 1
	movl	%eax, %esi
	leaq	.LC38(%rip), %rax
	movq	%rax, %rdi
	movl	$0, %eax
	call	printf@PLT
	.loc 1 306 28 is_stmt 1
	movl	$-1, %eax
	jmp	.L74
.L52:
.LBE10:
...
.L58:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 356 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
	movq	%rax, %rdi
...
.L63:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 362 13 is_stmt 0 discriminator 1
	movl	-30920(%rbp), %eax
	movq	%r12, %r8
	movq	%rbx, %rcx
	movl	%eax, %edx
...
.L70:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 394 9 is_stmt 0 discriminator 1
	movq	%r13, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
...
.LPSRL1:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 413 9 is_stmt 0 discriminator 1
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC45(%rip), %rax
...
.L78:
	...
	jmp	.L80
.L79:
	.loc 1 422 84 discriminator 2
	movl	$0, %eax
.L80:
	.loc 1 422 10 discriminator 4
	movq	%rax, -30784(%rbp)
	.loc 1 424 5
	movq	-30824(%rbp), %rax
	movq	16(%rax), %r12
...
.LBB18:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 448 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC47(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L88:
	...
	movq	%rax, %rdi
	call	strdup@PLT
	.loc 1 457 44 discriminator 1
	movq	%rax, (%rbx)
	.loc 1 455 46 discriminator 3
	addl	$1, -30804(%rbp)
.L87:
	.loc 1 455 31 discriminator 1
	movl	-30812(%rbp), %eax
	cmpl	%eax, -30804(%rbp)
	jl	.L88
.LBE17:
...
.L84:
	...
	cmpl	$0, -30840(%rbp)
	je	.L91
	.loc 1 468 33 discriminator 1
	movq	-30832(%rbp), %rax
	movl	4(%rax), %eax
	.loc 1 468 28 discriminator 1
	testl	%eax, %eax
	jle	.L91
	.loc 1 470 17
	movl	-30796(%rbp), %eax
...
.L90:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 476 13 is_stmt 0 discriminator 1
	movl	-30796(%rbp), %eax
	movq	%r12, %r8
	movq	%rbx, %rcx
	movl	%eax, %edx
...
.L116:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 594 9 is_stmt 0 discriminator 1
	movq	-24(%rbp), %rsi
	movl	-36(%rbp), %eax
	movl	$0, %ecx
	movl	%eax, %edi
...
.LBB21:
	...
	jmp	.L121
.L122:
	.loc 1 626 9 is_stmt 0 discriminator 3
	movq	-31040(%rbp), %rax
	movl	-31060(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -31060(%rbp)
.L121:
	.loc 1 626 9 discriminator 1
	cmpl	$15, -31060(%rbp)
	jbe	.L122
.LBE21:
...
.L123:
	...
	.loc 1 645 13
	call	gettid@PLT
	.loc 1 645 13 is_stmt 0 discriminator 1
	movl	$10, %edx
	movl	%eax, %esi
	leaq	.LC60(%rip), %rax
	movq	%rax, %rdi
...
.L128:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 674 13 is_stmt 0 discriminator 1
	leaq	-30752(%rbp), %rdx
	movl	-31052(%rbp), %eax
	movq	%rdx, %rcx
	movl	%eax, %edx
...
.LBB23:
	...
	movq	-30984(%rbp), %rbx
	call	gettid@PLT
	.loc 1 690 17 is_stmt 0 discriminator 1
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC63(%rip), %rax
	movq	%rax, %rdi
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 694 21 is_stmt 0 discriminator 1
	movq	-31080(%rbp), %rax
	movl	4(%rax), %eax
	movq	-31032(%rbp), %rsi
	movl	$0, %ecx
	movl	%eax, %edi
	call	send@PLT
	.loc 1 694 20 is_stmt 1 discriminator 2
	testq	%rax, %rax
	jns	.L141
	.loc 1 696 104
	call	__errno_location@PLT
	.loc 1 696 21 discriminator 1
	movl	(%rax), %ebx
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 696 21 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
	movq	%rax, %rdi
...
.LBE23:
	...
	movl	%eax, %edx
	.loc 1 702 29 is_stmt 0 discriminator 1
	movq	-31080(%rbp), %rsi
	leaq	-31008(%rbp), %rax
	movl	$1, %r8d
	movl	$1, %ecx
	...
	movl	%eax, -31044(%rbp)
	.loc 1 705 24 is_stmt 1
	movl	-30916(%rbp), %eax
	.loc 1 705 16
	cmpl	$1, %eax
	jne	.L133
	.loc 1 705 56 discriminator 1
	movl	-30920(%rbp), %eax
	.loc 1 705 47 discriminator 1
	testl	%eax, %eax
	je	.L142
.L133:
	.loc 1 705 85 discriminator 3
	cmpl	$0, -31044(%rbp)
	js	.L142
	.loc 1 709 13
	leaq	-31008(%rbp), %rax
