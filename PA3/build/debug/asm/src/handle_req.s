...
.L61:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 324 9 is_stmt 0 discriminator 1
	movq	%r13, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
...
.LPSRL1:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 343 9 is_stmt 0 discriminator 1
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC34(%rip), %rax
...
.L69:
	...
	movl	%eax, %edi
	call	lseek@PLT
	.loc 1 352 84 discriminator 1
	testq	%rax, %rax
	jle	.L70
	.loc 1 352 56 discriminator 1
	movl	-30836(%rbp), %eax
	movl	$1, %edx
	movl	$0, %esi
	movl	%eax, %edi
	...
	jmp	.L71
.L70:
	.loc 1 352 84 discriminator 2
	movl	$0, %eax
.L71:
	.loc 1 352 10 discriminator 4
	movq	%rax, -30784(%rbp)
	.loc 1 354 5
	movq	-30824(%rbp), %rax
	movq	16(%rax), %r12
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 354 5 is_stmt 0 discriminator 1
	movq	-30784(%rbp), %rdx
	movq	%rdx, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
...
.LBB13:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 378 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC36(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L79:
	...
	movq	%rax, %rdi
	call	strdup@PLT
	.loc 1 387 44 discriminator 1
	movq	%rax, (%rbx)
	.loc 1 385 46 discriminator 3
	addl	$1, -30804(%rbp)
.L78:
...
.L75:
	...
	cmpl	$0, -30840(%rbp)
	je	.L82
	.loc 1 398 33 discriminator 1
	movq	-30832(%rbp), %rax
	movl	4(%rax), %eax
	.loc 1 398 28 discriminator 1
	testl	%eax, %eax
	jle	.L82
	.loc 1 400 17
	movl	-30796(%rbp), %eax
	...
	.loc 1 402 100
	call	__errno_location@PLT
	.loc 1 402 17 discriminator 1
	movl	(%rax), %ebx
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 402 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
	movq	%rax, %rdi
...
.L81:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 406 13 is_stmt 0 discriminator 1
	movl	-30796(%rbp), %eax
	movq	%r12, %r8
	movq	%rbx, %rcx
	movl	%eax, %edx
...
.L73:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 426 9 is_stmt 0 discriminator 1
	movq	%r13, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
...
.L87:
	...
	call	free@PLT
.L86:
	.loc 1 435 43 discriminator 2
	addl	$1, -30800(%rbp)
.L85:
	.loc 1 435 27 discriminator 1
	movl	-30800(%rbp), %eax
	cmpl	-30808(%rbp), %eax
	jl	.L87
.LBE14:
...
.L107:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 536 9 is_stmt 0 discriminator 1
	movq	-24(%rbp), %rsi
	movl	-36(%rbp), %eax
	movl	$0, %ecx
	movl	%eax, %edi
...
.LBB16:
	...
	jmp	.L112
.L113:
	.loc 1 568 9 is_stmt 0 discriminator 3
	movq	-31040(%rbp), %rax
	movl	-31060(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -31060(%rbp)
...
.L114:
	...
	.loc 1 587 13
	call	gettid@PLT
	.loc 1 587 13 is_stmt 0 discriminator 1
	movl	$10, %edx
	movl	%eax, %esi
	leaq	.LC49(%rip), %rax
	movq	%rax, %rdi
...
.LBB17:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 610 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC50(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L119:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 616 13 is_stmt 0 discriminator 1
	leaq	-30752(%rbp), %rdx
	movl	-31052(%rbp), %eax
	movq	%rdx, %rcx
	movl	%eax, %edx
...
.LBB18:
	...
	movq	-30984(%rbp), %rbx
	call	gettid@PLT
	.loc 1 632 17 is_stmt 0 discriminator 1
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC52(%rip), %rax
	movq	%rax, %rdi
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 636 21 is_stmt 0 discriminator 1
	movq	-31080(%rbp), %rax
	movl	4(%rax), %eax
	movq	-31032(%rbp), %rsi
	movl	$0, %ecx
	movl	%eax, %edi
	call	send@PLT
	.loc 1 636 20 is_stmt 1 discriminator 2
	testq	%rax, %rax
	jns	.L132
	.loc 1 638 104
	call	__errno_location@PLT
	.loc 1 638 21 discriminator 1
	movl	(%rax), %ebx
	call	gettid@PLT
	movl	%eax, %edx
...
.LBE18:
	...
	movl	%eax, %edx
	.loc 1 645 29 is_stmt 0 discriminator 1
	movq	-31080(%rbp), %rsi
	leaq	-31008(%rbp), %rax
	movl	$1, %r8d
	movl	$1, %ecx
	...
	movl	%eax, -31044(%rbp)
	.loc 1 648 24 is_stmt 1
	movl	-30916(%rbp), %eax
	.loc 1 648 16
	cmpl	$1, %eax
	jne	.L124
	.loc 1 648 56 discriminator 1
	movl	-30920(%rbp), %eax
	.loc 1 648 47 discriminator 1
	testl	%eax, %eax
	je	.L133
.L124:
	.loc 1 648 85 discriminator 3
	cmpl	$0, -31044(%rbp)
	js	.L133
	.loc 1 652 13
	leaq	-31008(%rbp), %rax
