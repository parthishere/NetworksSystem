...
.LC33:
	.string	"[+] Detected chunked encoding"
.LC34:
	.string	"\r\n0\r\n\r\n"
	.align 8
.LC35:
...
.LC39:
	...
	.align 8
.LC40:
	.string	"[!] Missing Content-Length in non-chunked response"
.LC41:
	.string	"[+] Found end chunk marker"
.LC42:
	.string	" linkcount %d link chunks %p\n"
.LC43:
	.string	"found link"
	.align 8
.LC44:
...
.LC47:
	...
	.align 8
.LC48:
	.string	"nc All links = %p, prefetch %d \n"
	.align 8
.LC49:
...
.L53:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 333 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	movq	%rbx, %rcx
	leaq	.LC44(%rip), %rsi
	movq	%rax, %rdi
...
.L61:
	...
	movq	%rax, %rdi
	call	strdup@PLT
	.loc 1 342 44 discriminator 1
	movq	%rax, (%rbx)
	.loc 1 340 46 discriminator 3
	addl	$1, -30940(%rbp)
.L60:
	.loc 1 340 31 discriminator 1
	movl	-30972(%rbp), %eax
	cmpl	%eax, -30940(%rbp)
	jl	.L61
.LBE14:
...
.L57:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 357 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
	movq	%rax, %rdi
...
.L63:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 363 13 is_stmt 0 discriminator 1
	movl	-30920(%rbp), %eax
	movq	%r12, %r8
	movq	%rbx, %rcx
	movl	%eax, %edx
...
.L62:
	...
	cmpl	$0, -30956(%rbp)
	jle	.L64
	.loc 1 372 33 discriminator 1
	movl	-30924(%rbp), %eax
	cmpl	-30956(%rbp), %eax
	jge	.L65
.L64:
	.loc 1 372 66 discriminator 3
	cmpl	$0, -30948(%rbp)
	je	.L67
	.loc 1 373 27
	cmpl	$0, -30944(%rbp)
...
.L70:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 395 9 is_stmt 0 discriminator 1
	movq	%r13, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
...
.LC51:
	...
	.align 8
.LC52:
	.string	"c All links = %p, prefetch %d \n"
	.align 8
.LC53:
...
.LPSRL1:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 414 9 is_stmt 0 discriminator 1
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC50(%rip), %rax
...
.L78:
	...
	movl	%eax, %edi
	call	lseek@PLT
	.loc 1 423 84 discriminator 1
	testq	%rax, %rax
	jle	.L79
	.loc 1 423 56 discriminator 1
	movl	-30836(%rbp), %eax
	movl	$1, %edx
	movl	$0, %esi
	movl	%eax, %edi
	...
	jmp	.L80
.L79:
	.loc 1 423 84 discriminator 2
	movl	$0, %eax
.L80:
	.loc 1 423 10 discriminator 4
	movq	%rax, -30784(%rbp)
	.loc 1 425 5
	movq	-30824(%rbp), %rax
	movq	16(%rax), %r12
...
.LBB18:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 449 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC53(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L88:
	...
	movq	%rax, (%rbx)
	.loc 1 456 46 discriminator 3
	addl	$1, -30804(%rbp)
.L87:
	.loc 1 456 31 discriminator 1
	movl	-30812(%rbp), %eax
	cmpl	%eax, -30804(%rbp)
	jl	.L88
.LBE17:
...
.L90:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 477 13 is_stmt 0 discriminator 1
	movl	-30796(%rbp), %eax
	movq	%r12, %r8
	movq	%rbx, %rcx
	movl	%eax, %edx
...
.L82:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 486 9 is_stmt 0 discriminator 1
	movq	%r13, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
...
.L116:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 595 9 is_stmt 0 discriminator 1
	movq	-24(%rbp), %rsi
	movl	-36(%rbp), %eax
	movl	$0, %ecx
	movl	%eax, %edi
...
.LBB21:
	...
	jmp	.L121
.L122:
	.loc 1 627 9 is_stmt 0 discriminator 3
	movq	-31040(%rbp), %rax
	movl	-31060(%rbp), %edx
	movq	$0, (%rax,%rdx,8)
	addl	$1, -31060(%rbp)
.L121:
	.loc 1 627 9 discriminator 1
	cmpl	$15, -31060(%rbp)
	jbe	.L122
.LBE21:
...
.L123:
	...
	.loc 1 646 13
	call	gettid@PLT
	.loc 1 646 13 is_stmt 0 discriminator 1
	movl	$10, %edx
	movl	%eax, %esi
	leaq	.LC66(%rip), %rax
	movq	%rax, %rdi
...
.LBB22:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 669 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC67(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L128:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 675 13 is_stmt 0 discriminator 1
	leaq	-30752(%rbp), %rdx
	movl	-31052(%rbp), %eax
	movq	%rdx, %rcx
	movl	%eax, %edx
...
.LBB23:
	...
	movq	-30984(%rbp), %rbx
	call	gettid@PLT
	.loc 1 691 17 is_stmt 0 discriminator 1
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC69(%rip), %rax
	movq	%rax, %rdi
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 695 21 is_stmt 0 discriminator 1
	movq	-31080(%rbp), %rax
	movl	4(%rax), %eax
	movq	-31032(%rbp), %rsi
	movl	$0, %ecx
	movl	%eax, %edi
	call	send@PLT
	.loc 1 695 20 is_stmt 1 discriminator 2
	testq	%rax, %rax
	jns	.L141
	.loc 1 697 104
	call	__errno_location@PLT
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 697 21 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
	movq	%rax, %rdi
...
.LBE23:
	...
	movl	%eax, %edx
	.loc 1 703 29 is_stmt 0 discriminator 1
	movq	-31080(%rbp), %rsi
	leaq	-31008(%rbp), %rax
	movl	$1, %r8d
	movl	$1, %ecx
	...
	movl	%eax, -31044(%rbp)
	.loc 1 706 24 is_stmt 1
	movl	-30916(%rbp), %eax
	.loc 1 706 16
	cmpl	$1, %eax
	jne	.L133
	.loc 1 706 56 discriminator 1
	movl	-30920(%rbp), %eax
	.loc 1 706 47 discriminator 1
	testl	%eax, %eax
	je	.L142
.L133:
	.loc 1 706 85 discriminator 3
	cmpl	$0, -31044(%rbp)
	js	.L142
	.loc 1 710 13
	leaq	-31008(%rbp), %rax
