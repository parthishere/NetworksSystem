...
.LPSRL1:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 422 9 is_stmt 0 discriminator 1
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC45(%rip), %rax
...
.LBB18:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 457 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC47(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L88:
	...
	movq	%rax, %rdi
	call	strdup@PLT
	.loc 1 466 44 discriminator 1
	movq	%rax, (%rbx)
	.loc 1 464 46 discriminator 3
	addl	$1, -30804(%rbp)
.L87:
	.loc 1 464 31 discriminator 1
	movl	-30812(%rbp), %eax
	cmpl	%eax, -30804(%rbp)
	jl	.L88
.LBE17:
...
.L84:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 481 17 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movl	%ebx, %ecx
	leaq	.LC17(%rip), %rsi
	movq	%rax, %rdi
...
.L90:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 485 13 is_stmt 0 discriminator 1
	movl	-30796(%rbp), %eax
	movq	%r12, %r8
	movq	%rbx, %rcx
	movl	%eax, %edx
...
.L82:
	...
	movq	24(%rax), %rbx
	call	gettid@PLT
	.loc 1 494 9 is_stmt 0 discriminator 1
	movq	%r13, %r8
	movq	%r12, %rcx
	movq	%rbx, %rdx
	movl	%eax, %esi
...
.L116:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 603 9 is_stmt 0 discriminator 1
	movq	-24(%rbp), %rsi
	movl	-36(%rbp), %eax
	movl	$0, %ecx
	movl	%eax, %edi
...
.LBE21:
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 646 13 is_stmt 0 discriminator 2
	movq	stderr(%rip), %rax
	movq	%r12, %r8
	movl	%ebx, %ecx
	leaq	.LC59(%rip), %rsi
...
.LBB22:
	...
	movl	%eax, %edi
	call	recv@PLT
	.loc 1 668 27 discriminator 1
	movl	%eax, -31040(%rbp)
	.loc 1 668 16 discriminator 1
	cmpl	$0, -31040(%rbp)
	js	.L139
	.loc 1 675 16
	cmpl	$0, -31040(%rbp)
	...
	call	gettid@PLT
	movl	%eax, %edx
	.loc 1 677 17 is_stmt 0 discriminator 1
	movq	stderr(%rip), %rax
	leaq	.LC61(%rip), %rcx
	movq	%rcx, %rsi
	movq	%rax, %rdi
...
.L128:
	...
	call	gettid@PLT
	movl	%eax, %esi
	.loc 1 683 13 is_stmt 0 discriminator 1
	leaq	-30752(%rbp), %rdx
	movl	-31044(%rbp), %eax
	movq	%rdx, %rcx
	movl	%eax, %edx
...
.L129:
	...
	movq	-30984(%rbp), %rbx
	call	gettid@PLT
	.loc 1 699 17 is_stmt 0 discriminator 1
	movq	%rbx, %rdx
	movl	%eax, %esi
	leaq	.LC63(%rip), %rax
	movq	%rax, %rdi
...
.L131:
	...
	movl	%eax, %edx
	.loc 1 708 29 is_stmt 0 discriminator 1
	movq	-31064(%rbp), %rsi
	leaq	-31008(%rbp), %rax
	movl	$1, %r8d
	movl	$1, %ecx
	...
	movl	%eax, -31036(%rbp)
	.loc 1 711 24 is_stmt 1
	movl	-30916(%rbp), %eax
	.loc 1 711 16
	cmpl	$1, %eax
	jne	.L132
	.loc 1 711 56 discriminator 1
	movl	-30920(%rbp), %eax
	.loc 1 711 47 discriminator 1
	testl	%eax, %eax
	je	.L140
.L132:
	.loc 1 711 85 discriminator 3
	cmpl	$0, -31036(%rbp)
	js	.L140
	.loc 1 715 13
	leaq	-31008(%rbp), %rax
