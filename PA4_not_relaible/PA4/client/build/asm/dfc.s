...
.L5:
	...
	call	strlen@PLT
	movq	%rax, %rdx
	.loc 1 40 32 is_stmt 0 discriminator 1
	movq	-1048(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	strndup@PLT
...
.L12:
	...
	movl	(%rax), %eax
	.loc 1 87 19 is_stmt 1 discriminator 1
	cmpl	$17, %eax
	jne	.L14
	.loc 1 88 13
	leaq	.LC8(%rip), %rax
